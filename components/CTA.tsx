...
const CTA: FC = () => {
	...
	return (
		...
		>
			<div className="flex flex-col gap-6 lg:gap-12 xl:gap-24 2xl:flex-row py-16 px-6 sm:px-16 lg:px-20">
				...
				<div className="flex flex-col">
					<motion.span
						...
						viewport={{once: true}}
						whileInView={fadeInUp}
						className="text-center mb-3 lg:text-left text-base sm:text-xl sm:text-2xl text-purple"
					>
						...
						wait—let&apos;s start coding the future today.
					</motion.span>
					<Paragraph
					...
					<div className="flex flex-col sm:flex-row gap-6 xl:gap-12 mt-6 items-center justify-center lg:justify-start">
						<Link
							target="blank"
							href={`mailto:toddowenmpeli@rocketmail.com?subject=${content.name}: Developer Portfolio`}
						>
							<motion.button
								role="button"
								type="button"
