					...
					<div className="flex flex-col lg:flex-row w-full items-center justify-center gap-20 lg:gap-4">
						...
						<div className="w-full lg:w-1/2">
							...
							>
								<li>
									<Link
										className="uppercase font-[900] text-8xl md:text-9xl text-pinkPurple hover:text-yellow transition-all ease-in-out duration-500 md:mr-[50px] lg:mr-[-100px] hover:mr-[5px] hover:md:mr-[100px]"
										href="#project"
									>
										projects
									</Link>
								...
								<li>
									<Link
										className="uppercase font-[900] text-8xl md:text-9xl text-pinkPurple hover:text-yellow transition-all ease-in-out duration-500 md:mr-[50px] lg:mr-[-100px] hover:mr-[50px] hover:md:mr-[100px]"
										href="#experience"
									>
										about
									</Link>
								...
								<li>
									<Link
										className="uppercase font-[900] text-8xl md:text-9xl text-pinkPurple hover:text-yellow transition-all ease-in-out duration-500 md:mr-[50px] lg:mr-[-100px] hover:mr-[15px] hover:md:mr-[100px]"
										href="#contact"
									>
										contact
									</Link>
