...
const BlueInventory: FC = () => {
	return (
		<>
			<section
				id="blueInventory"
				className={styles.starProject + " flex flex-col"}
			>
				<div
					className="flex flex-col py-16 px-6 sm:px-16 lg:px-20 bg-center bg-no-repeat bg-cover"
					style={{
				...
				<div className="bg-white py-24 flex flex-col xl:flex-row px-6 sm:px-16 gap-12 xl:gap-24">
					<div className="w-full xl:w-[40%]">
						<motion.span
							initial={initial}
							viewport={{once: true}}
							whileInView={fadeInUp}
							className="text-center lg:text-left font-bold text-2xl text-flatBlueGreyDarker"
						>
					...
					<div
						className={
							styles.techStack +
							" w-full xl:w-[20%] flex flex-col sm:flex-row xl:flex-col items-start xl:justify-start justify-center gap-6"
						}
					>
