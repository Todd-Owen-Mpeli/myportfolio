						...
						>
							<Form className="container mx-auto transition-all ease-in-out duration-[0.5s] md:max-w-xl shadow-12xl">
								{loading ? (
									...
									>
										<h4 className="text-5xl sm:text-6xl lg:text-7xl font-semibold text-center uppercase text-blue">
											Sending Message...
										</h4>
									</motion.div>
								) : messageSent ? (
									<motion.div
										...
										className="flex items-center justify-center my-4 mb-8 gap-x-2"
									>
										<h4 className="text-5xl sm:text-6xl lg:text-7xl font-semibold text-center uppercase text-yellow">
											Message Sent
										</h4>
									</motion.div>
								) : errorMessage ? (
									<motion.div
										...
										className="flex items-center justify-center my-4 mb-8 gap-x-2"
									>
										<h4 className="text-xl sm:text-2xl font-semibold text-center uppercase text-pinkRed">
									...
									<motion.h3
										...
										whileInView={fadeIn}
										viewport={{once: true}}
										className="mx-auto mb-16 text-5xl sm:text-6xl lg:text-7xl font-semibold text-center uppercase"
									>
										Get In Touch!
									</motion.h3>
								)}
								...
								>
									...
									>
										<ReCAPTCHA
											sitekey={`6Ldn0r4nAAAAALXXhFuLzL9wscHD_S61WUmxN4c5`}
									...
									>
										...
										>
											...
											<h3 className="text-xl tracking-widest text-white uppercase sm:tracking-wider sm:text-2xl">
												{loading
													? "Sending Message..."
													: messageSent
													? "Message Sent!"
