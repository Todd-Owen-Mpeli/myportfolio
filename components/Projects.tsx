					...
					<div className="mt-12 xl:mt-28 grid grid-cols-1 lg:grid-cols-2 items-start justify-between gap-6 xl:gap-y-12">
						<div className="flex flex-col gap-2 items-center justify-center bg-flatBlueGreyDarker py-8 px-4 sm:p-8 rounded-md">
							<Link
								...
								href={`https://www.crdbbankfoundation.co.tz/`}
							>
								<Image
									width={1000}
									height={1000}
									src="/img/projects/Home-CRDB-Bank-Foundation.png"
									alt={"CRDB Bank Foundation"}
							...
							<div className="flex flex-col xl:flex-row gap-4 items-center justify-between w-full">
								<div className="flex flex-col gap-4 xl:gap-8 justify-between items-center lg:items-start">
									<h3 className="uppercase text-center lg:text-left font-[900] text-xl sm:text-2xl lg:text-3xl text-white tracking-[0.25rem]">
										CRDB Bank Foundation Website
									</h3>
									<Paragraph
										content={`<p>This is a Next.js 14 project website I've built for a NGO Foundation. CRDB Bank Foundation is a wing of the Bank that enhances the humane side of a giant corporation..
										</br>
										</br>
									...
									<div>
										...
										<Paragraph
											content={`<p>Next.js 14,  React 18, Typescript, Tailwindcss, and a Headless CMS, REST API&apos;s, Apollo & Apollo/client, Sitemap, Google ReCaptcha v2, HTML 5, CSS3, Javascript, Framer Motion Animation.</p>`}
								...
								<div className="flex flex-col lg:flex-row xl:flex-col gap-6 mt-6 items-center justify-center lg:justify-start">
									...
									<Link
										target="blank"
										href={`https://github.com/BluetechDigital/CRDB-Bank-Foundation`}
									>
										<motion.button
											role="button"
											type="button"
